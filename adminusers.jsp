	...
	String uid = (String)session.getAttribute("uid");
		...
		<div align="center">
			...
			<%
				...
				out.println("<th align='left' colspan='5' style='color:white'> Stations : </th> </tr>");
				out.println("<tr bgcolor=#333333 style='color:white'>	<th> Stationid Id</th> <th> StationName </th> <th> Order </th></tr>");

				int flag=0;
				while(rs.next()){
					flag=1;
					out.println("<tr style='color:blue; font-weight:bold'>");
					out.println("<td>"+rs.getString("station_id")+"</td><td>"+rs.getString("station_name")+"</td><td>"+rs.getString("km")+"</td>");
					out.println("</tr>");
				}
				out.println("</table>");
